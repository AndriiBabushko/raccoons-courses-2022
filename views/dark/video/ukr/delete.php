            ...
            <form action="" method="post" enctype="multipart/form-data" class="d-flex flex-column align-items-center justify-content-center position-relative"
                ...
                <div class="text-white" id="content">
                    ...
                    <?php if (!empty($videos) && empty($selectedVideo)): ?>
                        ...
                        <div class="form-group mb-3">
                            <button type='submit' id='buttonAutofillFields' class='btn btn-secondary w-100'>Вибрати відео</button>
                        </div>
                    <?php endif; ?>
                    ...
                    <?php if (!empty($selectedVideo)): ?>
                        <div class="form-group mb-3">
                            ...
                            <div class="d-flex flex-wrap justify-content-evenly w-100 mt-3">
                                ...
                                <a href="/courses/ukr/view/<?php echo $id_good; ?>" id='buttonCancelDeleteVideo' class='btn btn-secondary'>
                                    Повернутися до сторінки перегляду курсу
                                </a>
                            </div>
                        </div>
                    <?php endif; ?>
