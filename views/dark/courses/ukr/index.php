    ...
    <div class="row">
        ...
        <div class="col">
            <div class="row my-2">
                ...
                <h1 class="title fs-4 text-center text-white pb-2 border-bottom border-2" id="productsTitle">Наші курси:</h1>
            </div>
                                ...
                                <div class="card-body">
                                    ...
                                    <p class="card-text comments-count">
                                        ...
                                        <?php if ($good['comments_count'] != 0): ?>
                                            ...
                                            <?php if ($good['comments_count'] == 1) echo "коментар від користувача."; else echo "коментарі від користувачів." ?>
                                        <?php endif; ?>
                                    </p>
                                    <?php if (!empty($user)): ?>
