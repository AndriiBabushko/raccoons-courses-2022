        ...
        <div class="form-container d-flex justify-content-center" id="goodUpdateContainer">
            <form action="" method="post" enctype="multipart/form-data" class="d-flex flex-column align-items-center justify-content-center position-relative"
                ...
                <div class="text-white" id="content">
                    <h3 class="h3 my-4 pb-1 text-center title">Update good form!</h3>
                    ...
                    <div class="form-group mb-3">
                        ...
                        <textarea class="input form-control form-control-lg bg-dark text-white short"
                                  name="short_description" id="goodShortDescription"
                                  placeholder="Tell a little what this good is about..."
                    ...
                    <div class="form-group mb-3">
                        ...
                        <textarea class="input form-control form-control-lg bg-dark text-white long"
                                  name="description" id="goodDescription"
                                  placeholder="Tell more what this good is about..." rows="10"
                    ...
                    <div class="form-group mb-3">
                        ...
                        <select class="form-select bg-dark text-white" name="id_category" id="goodCategory">
                            <option value="NULL">Good category</option>
                    ...
                    <div class="form-group mb-3">
                        <button type='submit' id='buttonUpdateGood' class='btn btn-primary w-100'>Update category</button>
                    </div>
                </div>
            </form>
        </div>
