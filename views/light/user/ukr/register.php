                ...
                <div class="" id="content">
                    ...
                    <div class="form-group mb-3">
                        ...
                        <div class="invalid-feedback">
                            Ім'я містить числа або довжина менша за 2.
                        </div>
                    </div>
                    ...
                    <div class="form-group mb-3">
                        ...
                        <div class="invalid-feedback">
                            Прізвище містить числа або довжина менша за 2.
                        </div>
                    </div>
                    ...
                    <div class="form-group mb-3">
                        ...
                        if (!empty($errors)) {
                            ...
                            echo "<div class='invalid-feedback'>Електронна адреса неправильна!</div>";
                        }
                        ?>
                    </div>
                    ...
                    <div class="form-group mb-3">
                        ...
                        <div class="input-group">
                            <input type='password' name='password' id='password' class='input form__password form-control form-control-lg' placeholder="Введіть пароль">
