        ...
        <div class="form-container d-flex justify-content-center" id="formContainer">
            <form action="" method="post" enctype="multipart/form-data" class="d-flex flex-column align-items-center justify-content-center position-relative"
                ...
                <div class="" id="content">
                    <h3 class="h3 my-4 text-center title">Join to our Raccoons' team!</h3>

                    <div class="form-group mb-3">
                        <label for="textFirstName" id="labelFirstName" class="form__label_first_name form-label label">First name</label>
                        <input type='text' name='textFirstName' id='textFirstName' class='input form__text_first_name form-control form-control-lg'
                    ...
                    <div class="form-group mb-3">
                        ...
                        <input type='text' name='textLastName' id='textLastName' class='input form__text_last_name form-control form-control-lg' placeholder="Enter last name">
                        <div class="invalid-feedback">
                            Contain numbers or length is less than 2.
                        </div>
                    </div>
                    ...
                    <div class="form-group mb-3">
                        ...
                        <input type='tel' name='phoneNumber' id='phoneNumber' class='input form__phone_number form-control form-control-lg' placeholder="+380931234567">
                        <div class="invalid-feedback">
                    ...
                    <div class="form-group mb-3">
                        ...
                        <div class="input-group">
                            <input type='password' name='confirmPassword' id='confirmPassword' class='input form__confirm_password form-control form-control-lg'
                    ...
                    <div class="form-group mb-3">
                        <button type='submit' name='buttonSubmit' id='buttonRegister' class='form__button_submit btn btn-secondary w-100'>Sign in</button>
                    </div>
                </div>
            </form>
        </div>
