            ...
            <form action="" method="post" enctype="multipart/form-data" class="d-flex flex-column align-items-center justify-content-center position-relative"
                ...
                <div class="" id="content">
                    ...
                    <div class="form-group mb-3">
                        ...
                        <input type='text' name='name' id='categoryName' class='input form-control form-control-lg' placeholder="Backend розробка і тп..."
                    ...
                    <div class="form-group mb-3">
                        <label for="categoryPhoto" id="labelCategoryName" class="form-label label">Загальне зображення категорії</label>
