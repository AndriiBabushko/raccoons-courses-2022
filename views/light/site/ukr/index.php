        ...
        <div class="w-100">
            <div class="" id="startBlockContainer">
                <div class="col-xl-6 col-lg-5 col-md-12 col-sm-12 col-12" id="startBlockText">
                    ...
                    <p class="pt-3">
                        Raccourses - це не просто курси програмування. Це курси, де мінімум теорії і максимум реального досвіду та завдань. Тут під керівництвом ментора
                        вивчають різні мови програмування, інструменти та командну роботу.
                    </p>
