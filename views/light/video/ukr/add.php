        ...
        <div class="form-container d-flex justify-content-center" id="goodAddContainer">
            <form action="" method="post" enctype="multipart/form-data" class="d-flex flex-column align-items-center justify-content-center position-relative" id="videoAddForm">
                ...
                <div class="" id="content">
                    <h3 class="h3 my-4 pb-1 text-center title">Форма додавання відео!</h3>
                    ...
                    <div class="form-group mb-3">
                        ...
                        <input type='text' name='theme' id='videoTheme'
                               ...
                               placeholder="Вступ у React, і тд..."
                    ...
                    <div class="form-group mb-3">
                        <label for="videoName" id="labelVideoName" class="form-label label">Завантажте відео</label>
                    ...
                    <div class="form-group mb-3">
                        <button type='submit' id='buttonAddVideo' class='btn btn-success w-100'>Додати відео до курсу</button>
                    </div>
                </div>
            </form>
        </div>
