                        ...
                        <div class="d-flex flex-column align-items-center justify-content-center" id="userAvatar">
                            <label class="label">
                                ...
                                <div class="d-flex flex-column align-items-center justify-content-between" id="userAvatarBlock">
                                    ...
                                    if (!empty($user)):
                                        $userName = ucfirst($user['first_name']) . " settings.php" . ucfirst($user['last_name'])
                                        ?>
                                        <img
                        ...
                        <form action="" method="post" enctype="multipart/form-data" id="accountForm" class="my-2">
                            <div class="d-flex flex-wrap justify-content-between">
                                ...
                                if (!empty($updateStatus))
                                    if ($updateStatus)
                                        echo '<div class="alert alert-success my-3 w-100 text-center">Update was successful!</div>';
                                    else
                                        echo '<div class="alert alert-danger my-3 w-100 text-center">An error occurred while updating! Check data inputs.</div>';
                                ?>
